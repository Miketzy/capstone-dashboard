...
function Card() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 ml-[15.75rem]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {categories.map((category, index) => (
          <div
            key={index}
            className={`p-6 rounded-xl shadow-lg ${category.color} text-white text-center hover:scale-105 transition-all cursor-pointer`}
