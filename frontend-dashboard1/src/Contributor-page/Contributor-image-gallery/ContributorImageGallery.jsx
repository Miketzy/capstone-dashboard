...
function ContributorImageGallery() {
  ...
  return (
    <div className="contributor-image-gallery-container">
      <div className="contributorSearchbarGallery">
        <input
          type="text"
          className="contributorSearchInput"
      ...
      <br />
      <div className="contributor-grid-container">
        {filteredImages.length > 0 ? (
          filteredImages.map((image, index) => (
            <div key={index} className="contributor-grid-item">
              <img
          ...
          <p className="p">No species found</p>
        )}
      </div>
    </div>
  );
